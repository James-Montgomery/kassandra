...
# https://github.com/theapplegates/AllFixed/blob/82d842eb16563c4d3c375c5061cb290275a31cf4/content/posts/2019-09-05~hmc-bnn/hmc-bnn.mdx
# https://github.com/theapplegates/AllFixed/blob/82d842eb16563c4d3c375c5061cb290275a31cf4/license
...
def run_hmc(
    ...
    **kwargs,
    ...
    assert current_state is not None or resume is not None, "Either current_state\
        or resume is required when calling run_hmc"
    ...
    if sampler == "nuts":
        ...
        adaptive_kernel = step_size_adapter(kernel,
                                            num_adaptation_steps=num_burnin_steps)
...
def hmc_predict(weight_prior, bias_prior, init_state,
                X_train, y_train, X_test, y_test=None, **kwds):
